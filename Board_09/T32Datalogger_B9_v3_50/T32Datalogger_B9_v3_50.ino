...
*/
  ...
  if (SSD.getUsedSpace() > 7000000000) {  // 7 mb race typically needs 970K
    Warnings = Warnings | SSD_FAIL;
  }
  RaceStatus = RACE_NOTSTARTED;
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  // need > 90 + potatnial red flag min between race1 start and race2 start to consider a new race
...
void CreateUserInterface() {
  ...
  GForceZID = GForceG.add("Z", C_CYAN);
  //GForceID = GForceG.add("Total", C_YELLOW);
  GForceG.setLineThickness(GForceXID, 4);
  GForceG.setLineThickness(GForceYID, 4);
  GForceG.setLineThickness(GForceZID, 4);
