...
*/
  ...
  Serial.print("EBYE status "); Serial.println(TransOK);
...
void SendData() {
  ...
  Data.CARID_RPM = (CarID << 12) | (uint16_t)(mRPM & 0b0000111111111111);
